...
from application.core.exceptions.domain_exceptions import LocationNameAlreadyExistsException
from application.core.exceptions.domain_exceptions import ForbiddenActionException
from application.api.depends import get_get_location_by_id_use_case, get_create_location_use_case, get_update_location_use_case, get_delete_location_use_case, get_get_all_locations_use_case
